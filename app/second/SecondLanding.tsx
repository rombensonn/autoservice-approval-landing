    ...
    <header className="ds-header">
      <div className="container-page flex min-h-16 items-center justify-between gap-4">
        ...
        <nav aria-label="Основная навигация" className="flex items-center gap-3">
          <a className="ds-nav-link hidden text-sm font-medium sm:inline" href="#pain">
            Где теряется контроль
          </a>
          <a className="primary-button min-h-11 px-4 py-2 text-sm" href="#lead-form">
            Хочу тест
...
function DashboardShowcaseSection() {
  return (
    <section className="ds-interface-section section-pad" aria-label="Макет дашборда владельца автосервиса">
      <div className="container-page">
