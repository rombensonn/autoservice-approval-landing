      ...
      <div className="container-page flex min-h-16 items-center justify-between gap-4">
        ...
        <nav aria-label="Основная навигация" className="ds-main-nav">
          <div className="ds-nav-segment" aria-label="Разделы страницы">
            <a className="ds-nav-link focus-ring text-sm font-medium" href="#pain">
              Проблема
            </a>
...
function HeroSection() {
  return (
    <section className="ds-section--dark ds-third-hero-section text-inverse">
...
function SolutionSection() {
  return (
    <section id="workflow" className="ds-section ds-section--soft section-pad scroll-mt-20">
      <div className="container-page">
        <div className="max-w-3xl">
...
function BenefitsSection() {
  return (
    <section id="benefits" className="ds-section section-pad scroll-mt-20">
      <div className="container-page">
        <div className="max-w-3xl">
